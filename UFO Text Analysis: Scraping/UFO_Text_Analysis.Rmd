...
## I selected cities (Albuquerque/Boise/Myrtle Beach) that have relatively high UFO sightings to conduct text analysis and sentiment ## analysis.
...
## Term Frequency Analysis for 3 cities
```{r}
#Alb
library(tidytext)
...
## Sentiment Analysis for 3 cities
```{r}
#alb
library(sentimentr)
sent_albs <- c()
